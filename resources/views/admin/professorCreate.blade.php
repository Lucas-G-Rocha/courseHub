...
<div class="container d-flex justify-content-center mt-5 pb-5">
    ...
    <div class="card shadow-sm w-100" style="max-width: 700px;">
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <h1 class="mb-4 text-center">Cadastrar Professor</h1>

            <form action="{{ route('adminProfessorCreate') }}" method="POST">
                ...
                <div class="border rounded p-3 mb-4">
                    ...
                    <div class="form-check">
                        ...
                        <label for="create_user" class="form-check-label fw-semibold">
                            Criar usuário para este professor
                        </label>
                    </div>
...
<script>
    ...
    const passwordFields = document.getElementById('password').closest('.border');
